...
print_functions_before_transforms =  ['OffsetPropagation']#['Flatten', 'LowerSlices', 'LowerAdverbs', 'IndexifyAdverbs'] #['Fusion'] #['NegativeIndexElim'] #['Simplify']  

# show the function produced by each transformation?
print_functions_after_transforms = ['OffsetPropagation']#['Flatten', 'LowerSlices', 'LowerAdverbs', 'IndexifyAdverbs']# ['Fusion'] #IndexifyAdverbs'] #['Fusion'] #['NegativeIndexElim'] # ['Simplify'] #['IndexifyAdverbs']  
